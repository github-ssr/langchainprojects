...
def create_langchain() :
    ...
    chat_chain =  warning_extract_prompt | azure_chat_model | JsonOutputParser()
    return chat_chain
...
if __name__ == "__main__":
    ...
    download_pdf_file(pdf_url=lg_manual_url, pdf_file_path=pdf_file_path)

    chat_chain = create_langchain()
